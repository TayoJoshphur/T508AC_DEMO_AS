package android_jb.com.POSD.Win8View;
...
public class Win8View extends ImageView {
		...
		public void handleMessage(android.os.Message msg) {
			...
			case SCALING:
				...
				if (count < 4) {
					...
					isFinish = true;
					if (Win8View.this.mOnViewClickListener != null
							&& !isClicked) {
						isClicked = true;
						Win8View.this.mOnViewClickListener
								.onViewClick(Win8View.this);
					} else {
						isClicked = false;
					}
				}
	...
	public interface OnViewClickListener {
		void onViewClick(Win8View view);
	}
}
